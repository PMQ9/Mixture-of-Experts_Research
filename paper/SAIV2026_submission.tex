...
\begin{scope}[shift={(-3.8,0)}]
    \draw[blue!60, semithick, fill=blue!6] (0,0) circle (0.82);
    \node[font=\scriptsize, blue!70] at (0,1.0) {$B_\varepsilon(x)$};
    \fill[black] (0,0) circle (1.8pt);
    \node[font=\scriptsize, anchor=north, yshift=-1pt] at (0,0) {$x$};
    \foreach \a/\r in {30/0.4, 110/0.55, 200/0.35, 310/0.6, 160/0.25, 350/0.32, 70/0.65, 245/0.5} {
        \fill[gray!50] (\a:\r) circle (1pt);
    }
    \node[font=\scriptsize, gray!60] at (0.5,-0.55) {$x'$};
    \node[font=\footnotesize\bfseries, anchor=south] at (0,1.22) {(a) Perturbation ball};
\end{scope}
...
\begin{scope}[shift={(0,0)}]
    ...
    \node[box, fill=green!25] (esel) at (-0.6,-1.45) {$E_{m^*}$};
    \node[box, fill=red!12, text=gray!70] (eother) at (0.6,-1.45) {$E_{j{\neq}m^*}$};
    % Solid arrow: all inputs route to selected expert
    \draw[->, green!60!black, semithick] (0,-0.88) -- (esel.north);
    % Dashed crossed-out arrow: rejected expert
    \draw[->, red!40, thin, densely dashed] (0,-0.88) -- (eother.north);
    \node[font=\small, red!50, opacity=0.7] at (eother) {$\times$};
    \node[font=\scriptsize, green!50!black] at (0, -1.85) {\checkmark\ invariant};
    \node[font=\footnotesize\bfseries, anchor=south] at (0,1.22) {(b) Router invariance};
    \node[font=\scriptsize, text=green!45!black] at (0,-2.18) {Same $m^*$\; $\forall\, x'{\in}B_\varepsilon(x)$};
\end{scope}
...
\begin{scope}[shift={(3.8,0)}]
    ...
    \node[box, fill=green!25] (expert) at (0,-1.32) {$E_{m^*}$};
    \draw[->, semithick, black!70] (0,-0.88) -- (expert.north);
    \node[box, fill=orange!18, font=\scriptsize\bfseries] (yhat) at (0,-1.9) {$\hat{y}{=}y$};
    \draw[->, semithick, black!70] (expert.south) -- (yhat.north);
    \node[font=\scriptsize, green!50!black] at (0, -2.22) {\checkmark\ robust\; $\forall\, x'{\in}B_\varepsilon(x)$};
    \node[font=\footnotesize\bfseries, anchor=south] at (0,1.22) {(c) Expert robustness};
\end{scope}

% --- Composition arrows ---
\draw[->, semithick, gray!70] (-2.55,0) -- (-1.25,0);
\draw[->, semithick, gray!70] (1.25,0) -- (2.55,0);

% --- Bottom: composed result ---
\node[draw, semithick, rounded corners=3pt, fill=yellow!12, inner sep=3pt, font=\small, align=center] (result) at (0,-2.7) {%
...
\end{equation}
RT adds an adversarial term using PGD-generated perturbations ($\varepsilon = 8/255$):
\begin{equation}
