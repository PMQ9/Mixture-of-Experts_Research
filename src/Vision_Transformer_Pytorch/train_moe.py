...
NORMALIZAION_MEAN_R_GTSRB = 0.3432482055626116
NORMALIZAION_MEAN_G_GTSRB = 0.31312152061376486
NORMALIZAION_MEAN_B_GTSRB = 0.32248030768500435
...
def main():
    ...
    transform_train = transforms.Compose([
        ...
        transforms.ToTensor(),
        transforms.Normalize((NORMALIZAION_MEAN_R_GTSRB, NORMALIZAION_MEAN_G_GTSRB, NORMALIZAION_MEAN_B_GTSRB), (NORMALIZATION_STD_R_GTSRB, NORMALIZATION_STD_G_GTSRB, NORMALIZATION_STD_B_GTSRB)),
