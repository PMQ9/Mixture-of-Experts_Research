...
# Unified normalization for GTSRB and PTSD (recalculated 2025-11-30)
NORM_MEAN_R_UNIFIED_GTSRB_PTSD = 0.37098285517284213
NORM_MEAN_G_UNIFIED_GTSRB_PTSD = 0.344980446617646
NORM_MEAN_B_UNIFIED_GTSRB_PTSD = 0.35808274780502997
NORM_STD_R_UNIFIED_GTSRB_PTSD = 0.27002525939379074
NORM_STD_G_UNIFIED_GTSRB_PTSD = 0.25299964648776957
NORM_STD_B_UNIFIED_GTSRB_PTSD = 0.2570944266205675
...
UNIFIED_GTSRB_PTSD_NORM = {'mean': (NORM_MEAN_R_UNIFIED_GTSRB_PTSD, NORM_MEAN_G_UNIFIED_GTSRB_PTSD, NORM_MEAN_B_UNIFIED_GTSRB_PTSD),'std': (NORM_STD_R_UNIFIED_GTSRB_PTSD, NORM_STD_G_UNIFIED_GTSRB_PTSD, NORM_STD_B_UNIFIED_GTSRB_PTSD)}
