...
epsilon = 0.125/255;        % L-infinity perturbation bound (normalized)
reachMethod = 'approx-star'; % Options: 'exact-star', 'approx-star', 'abs-dom'
lp_solver = 'gurobi';  % Options: 'linprog', 'glpk', 'gurobi'
relaxFactor = 0.5;        % Relaxation factor for approximate methods (0 = tight)
numCores = 1;           % Number of parallel cores (1 = sequential)

% Image selection
test_image_idx = 8;     % Which test image to verify
